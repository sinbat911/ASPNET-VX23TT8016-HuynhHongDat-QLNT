...
namespace QuanLyNhaThuocWeb.Controllers
{
    public class TaiKhoansController : Controller
    {
        ...
        public TaiKhoansController(QuanLyNhaThuocDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaTaiKhoan,TenDangNhap,MatKhau,HoTen,VaiTro")] TaiKhoan taiKhoan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaTaiKhoan,TenDangNhap,MatKhau,HoTen,VaiTro")] TaiKhoan taiKhoan)
        {
